...
@WebServlet(name = "publishFromPeopleServlet", value = "/publishFromPeopleServlet")
public class publishFromPeopleServlet extends HttpServlet {
    @Override
...
//            response.sendRedirect("publish.jsp?status=success");
            response.sendRedirect("servlet/peopleIndex");
